...
// Output: [-3, -1, 1, 4], [-3, 1, 1, 2] -> Both the quadruplets add up to the target.
...
// Time: sorting will take O(n log(n)). Overall searchQuadruplets() 
// will take O(n log(n) + n^3), which is asymptotically equivalent to O(n^3).
